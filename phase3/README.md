...
- ### Scraper Program Procedure
  ...
  Step 3: The program outputs the post text, like count, reply count, repost count, and post creation date into a .txt with each post separated into a new line.
