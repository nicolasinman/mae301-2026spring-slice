...
- ### Scraper Program Procedure
  The current program that was created and placed in the GitHub repository for scraping X posts makes use of an older scraper that worked before Twitter became X and began requiring a paid  subscription for API access. Due to this API restriction, the program cannot 
